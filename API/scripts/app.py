...
import os
import pandas as pd
import manchester_sim_wrapper_ED_ver1oct22 as msw
import manchester_sim_wrapper_ED_verNov as mswNov
# from Fenfield_demoVK import SimEnfield6catchments as EnfSim


dir2save4debug='/home/soyduardorico/mysite/'
...
def GetDictToAPIreturnWSIMODenhanced():
    ...
    file_path = os.path.join(dir2save4debug, file_name)
