...
@author: bdobson
"""
from ventura.wsimod.nodes.nodes import Node, Tank
...
class WWTW(Node):
    ...
    def calculate_discharge(self):
        ...
        for key in constants.ADDITIVE_POLLUTANTS:
            ...
            if self.losses['volume']==0:
                print('we have a problem with self.losses being zero')
            else:
    ...
    def make_discharge(self):
        ...
        #VK tried changing the above to the below as was causing trouble
        #reply = self.push_distributed(self.discharge, 'Sewer')
