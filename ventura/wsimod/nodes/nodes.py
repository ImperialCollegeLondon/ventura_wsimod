...
@author: Barney
"""
from ventura.wsimod.nodes import nodes
from ventura.wsimod.nodes import *
from ventura.wsimod.core import constants
from ventura.wsimod.core.core import WSIObj
from ventura.wsimod.arcs.arcs import AltQueueArc, DecayArcAlt
    ...
    def query_handler(self, handler, ip, tag):
        ...
        try: 
            ...
            if tag not in handler.keys():
                ...
                #return handler[tag](ip)
                #the above line changed to the below  by VK  to avoid problems
                return handler['default'](ip)
            else:
